...
namespace Theraphosidae.Areas.Dashboard.Models.View.Spider
{
    public class AnimalTaxonomyView
    {
        ...
        [Required(ErrorMessage = "Podaj taksonomię królestwa ptasznika")]
        ...
        [Required(ErrorMessage = "Podaj taksonomię gromady ptasznika")]
        ...
        [Required(ErrorMessage = "Podaj taksonomię rzędu ptasznika")]
        ...
        [Required(ErrorMessage = "Podaj taksonomię rodziny ptasznika")]
        ...
        [Required(ErrorMessage = "Podaj taksonomię genus ptasznika")]
        ...
        [Required(ErrorMessage = "Podaj taksonomię species ptasznika")]
